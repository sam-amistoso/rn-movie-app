...
import { useFetchMovieDetailsQuery } from '@/services/movieApi';
...
const MovieDetails = () => {
  ...
  const {
    data: movieDetailsResp,
    isLoading,
    isFetching,
  } = useFetchMovieDetailsQuery(String(id), {
  ...
  const movie = useMemo(() => {
    return movieDetailsResp ? movieDetailsResp : null;
  }, [movieDetailsResp]);
